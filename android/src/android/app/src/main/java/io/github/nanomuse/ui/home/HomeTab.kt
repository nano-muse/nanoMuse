...
/**
 * The bottom bar, in Muse's order: chat, ideas, goals, library. (Muse has a feed between chat
 * and ideas; that arrives with the next version.) Icons are outlined at rest and filled when
 * selected, no labels — the bar reads as glyphs, the way Muse draws it.
 */
enum class HomeTab(
