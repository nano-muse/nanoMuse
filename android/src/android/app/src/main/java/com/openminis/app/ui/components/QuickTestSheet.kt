        ...
        return@withContext when (kind) {
            QuickTestKind.SPEECH_OUT -> {
                    ...
                    runCatching {
                        ...
                        val data = voice.synthesize(
                            com.openminis.app.provider.voice.VoiceOutputRequest(
                                input = "Hi! This is nanoMuse testing text to speech.",
                ...
                if (!voice.supportsVoiceInput) {
                    ...
                    val spoken = "Hello from nanoMuse, testing speech to text."
                ...
                val resp = provider.sendMessage(
                    messages = listOf(
                        LLMMessage(
                            ...
                            content = "Hi! I'm setting you up in nanoMuse. Say hello back in one short, friendly sentence.",
                        ),
                    ),
                    systemPrompt = null,
                    maxTokens = 128,
        ...
        QuickTestKind.IMAGE_GEN -> {
            ...
            runCatching {
                val resp = openAI.generateImage(
                    prompt = "A friendly cute mascot logo for an app called nanoMuse, minimalist, centered, soft colors",
                    n = 1,
                    size = "1024x1024",
                    quality = null,
                )
