...
|---|---|---|---|
| 是什么 | 作为服务的个人智能体：iOS、Android、网页、WhatsApp、Mac 客户端，连着每个用户一台的云端 VM | 跑在设备上的智能体 App，iOS 和 Android：Linux 沙盒、浏览器、设备工具、技能、记忆、工作区 | 一个 Muse 风格的智能体，跑在 OpenMinis 的端侧运行时上，完全开源，面向你的每一台设备 |
